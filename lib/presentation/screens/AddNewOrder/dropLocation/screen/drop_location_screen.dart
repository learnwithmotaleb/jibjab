...
import '../../pickLocation/widget/address_card_widget.dart';
import '../controller/drop_location_controller.dart';
...
class _DropLocationScreenState extends State<DropLocationScreen> {
  ...
  final controller = Get.put(DropLocationController());
              ...
              Padding(
                ...
                child: AppButton(
                  ...
                  onPressed: () {
                    ...
                    //
                    // }
                    Get.toNamed(RoutePath.dropOffScreen);
                  },
                ),
              ),
            ],
