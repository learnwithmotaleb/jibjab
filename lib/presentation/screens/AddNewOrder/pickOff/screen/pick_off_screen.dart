...
import '../controller/pick_off_controller.dart';
import '../widget/add_location_card_widget.dart';

class PickOffScreen extends StatefulWidget {
  const PickOffScreen({super.key});

  @override
  State<PickOffScreen> createState() => _PickOffScreenState();
}

class _PickOffScreenState extends State<PickOffScreen> {
  final controller = Get.put(PickOffController());
