                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(AppStrings.thingsWeStronglyRecommend.tr,style: AppFonts.regular12,),
                        SizedBox(height: Dimensions.h(16)),
                        Text(AppStrings.weAdviceYouNot.tr, style: AppFonts.regular12,),
                        SizedBox(height: Dimensions.h(16)),
                        Text(AppStrings.exampleOfSuchItemsAre.tr, style: AppFonts.regular12,),
                        SizedBox(height: Dimensions.h(16)),
                        Text(AppStrings.pianos.tr,style: AppFonts.regular12,),
                        SizedBox(height: Dimensions.h(16)),
                        Text(AppStrings.safetyBoxes.tr,style: AppFonts.regular12,),
                        SizedBox(height: Dimensions.h(16)),
                        Text(AppStrings.bouldersGravelSoil.tr,style: AppFonts.regular12,),
                      ],
                    ),
                  ),
