...
import '../controller/title_description_controller.dart';

class TitleDescriptionScreen extends StatefulWidget {
  const TitleDescriptionScreen({super.key});

  @override
  State<TitleDescriptionScreen> createState() =>
      _TitleDescriptionScreenState();
}

class _TitleDescriptionScreenState extends State<TitleDescriptionScreen> {
  final controller = Get.find<TitleDescriptionController>();
