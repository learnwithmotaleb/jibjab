...
import '../controller/b_pickoff_controller.dart';

class BPickoffScreen extends StatefulWidget {
  const BPickoffScreen({super.key});

  @override
  State<BPickoffScreen> createState() => _BPickoffScreenState();
}

class _BPickoffScreenState extends State<BPickoffScreen> {
  final controller = Get.put(BPickoffController());
