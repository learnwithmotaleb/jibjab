...
class BWalletScreen extends StatefulWidget {
  const BWalletScreen({super.key});

  @override
  State<BWalletScreen> createState() => _BWalletScreenState();
}

class _BWalletScreenState extends State<BWalletScreen> {
