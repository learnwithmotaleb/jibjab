...
import '../controller/b_dropoff_controller.dart';

class BDropoffScreen extends StatefulWidget {
  const BDropoffScreen({super.key});

  @override
  State<BDropoffScreen> createState() => _BDropoffScreenState();
}

class _BDropoffScreenState extends State<BDropoffScreen> {
  final controller = Get.put(BDropoffController());
