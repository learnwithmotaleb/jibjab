...
import '../controller/b_title_description_controller.dart';

class BTitleDescriptionScreen extends StatefulWidget {
  const BTitleDescriptionScreen({super.key});

  @override
  State<BTitleDescriptionScreen> createState() => _BTitleDescriptionScreenState();
}

class _BTitleDescriptionScreenState extends State<BTitleDescriptionScreen> {
  final controller = Get.find<BTitleDescriptionController>();
          ...
          child: Column(
            ...
            children: [
              ...
              AppButton(
                ...
                onPressed: () {
                  Get.toNamed(RoutePath.bSelectTimeSlot);
                },
              ),
