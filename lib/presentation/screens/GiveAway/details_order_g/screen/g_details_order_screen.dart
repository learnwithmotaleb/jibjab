...
import '../widget/g_info_row_order_details.dart';

class GDetailsOrderScreen extends StatefulWidget {
  const GDetailsOrderScreen({super.key});

  @override
  State<GDetailsOrderScreen> createState() => _GDetailsOrderScreenState();
}

class _GDetailsOrderScreenState extends State<GDetailsOrderScreen> {
