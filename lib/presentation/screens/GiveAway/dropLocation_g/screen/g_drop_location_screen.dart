...
import '../controller/g_drop_location_controller.dart';


class GDropLocationScreen extends StatefulWidget {
  const GDropLocationScreen({super.key});

  @override
  State<GDropLocationScreen> createState() => _GDropLocationScreenState();
}

class _GDropLocationScreenState extends State<GDropLocationScreen> {

  final controller = Get.put(GDropLocationController());
              ...
              Padding(
                ...
                child: AppButton(
                  ...
                  onPressed: () {
                    ...
                    //
                    // }
                    Get.toNamed(RoutePath.gDropOff);
                  },
                ),
              ),
            ],
