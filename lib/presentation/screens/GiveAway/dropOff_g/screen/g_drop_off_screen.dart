...
import '../../../AddNewOrder/pickOff/widget/add_location_card_widget.dart';
import '../../../details/widget/top_bar.dart';

import '../controller/g_drop_off_controller.dart';



class GDropOffScreen extends StatefulWidget {
  const GDropOffScreen({super.key});

  @override
  State<GDropOffScreen> createState() => _GDropOffScreenState();
}

class _GDropOffScreenState extends State<GDropOffScreen> {
  final controller = Get.put(GDropOffController());
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                TopBar(title: AppStrings.dropOff.tr),
                SizedBox(height: Dimensions.h(20)),
                ...
                Padding(
                  ...
                  child: AppButton(
                    ...
                    onPressed: () {
                      Get.toNamed(RoutePath.gDropOffMap);
                    },
                  ),
                ),
              ],
