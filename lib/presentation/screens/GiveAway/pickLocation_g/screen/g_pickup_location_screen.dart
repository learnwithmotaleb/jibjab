...
import '../controller/g_pickup_location_controller.dart';
import '../widget/g_address_card_widget.dart';

class GPickUpLocationScreen extends StatefulWidget {
  const GPickUpLocationScreen({super.key});

  @override
  State<GPickUpLocationScreen> createState() => _GPickUpLocationScreenState();
}

class _GPickUpLocationScreenState extends State<GPickUpLocationScreen> {
  final controller = Get.put(GPickupLocationController());
              ...
              Padding(
                ...
                child: AppButton(
                  ...
                  onPressed: () {
                    ...
                    //
                    // }
                    Get.toNamed(RoutePath.gPickOff);
                  },
                ),
              ),
            ],
