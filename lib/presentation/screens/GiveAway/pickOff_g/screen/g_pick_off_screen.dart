...
import '../controller/g_pick_off_controller.dart';
import '../widget/g_add_location_card_widget.dart';

class GPickOffScreen extends StatefulWidget {
  const GPickOffScreen({super.key});

  @override
  State<GPickOffScreen> createState() => _GPickOffScreenState();
}

class _GPickOffScreenState extends State<GPickOffScreen> {
  final controller = Get.put(GPickOffController());
              ...
              children: [
                ...
                Padding(
                  ...
                  child: AppButton(
                    ...
                    onPressed: () {
                     Get.toNamed(RoutePath.gPickOffMap);
                    },
                  ),
                ),
              ],
