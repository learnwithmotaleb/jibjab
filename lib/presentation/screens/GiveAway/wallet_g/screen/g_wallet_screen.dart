...
class GWalletScreen extends StatefulWidget {
  const GWalletScreen({super.key});

  @override
  State<GWalletScreen> createState() => _GWalletScreenState();
}

class _GWalletScreenState extends State<GWalletScreen> {
