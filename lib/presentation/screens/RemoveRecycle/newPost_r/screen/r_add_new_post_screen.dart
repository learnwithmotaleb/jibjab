...
import '../controller/r_add_new_post_controller.dart';

class RAddNewPostScreen extends StatefulWidget {
  const RAddNewPostScreen({super.key});

  @override
  State<RAddNewPostScreen> createState() => _RAddNewPostScreenState();
}

class _RAddNewPostScreenState extends State<RAddNewPostScreen> {
  final controller =
