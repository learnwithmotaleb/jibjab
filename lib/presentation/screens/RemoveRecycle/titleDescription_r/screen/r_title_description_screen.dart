...
import '../controller/r_title_description_controller.dart';

class RTitleDescriptionScreen extends StatefulWidget {
  const RTitleDescriptionScreen({super.key});

  @override
  State<RTitleDescriptionScreen> createState() =>
      _RTitleDescriptionScreenState();
}

class _RTitleDescriptionScreenState extends State<RTitleDescriptionScreen> {
  final controller = Get.find<RTitleDescriptionController>();
          ...
          child: Column(
            ...
            children: [
              ...
              AppButton(
                ...
                onPressed: () {
                  Get.toNamed(RoutePath.rWillPay);
                },
              ),
