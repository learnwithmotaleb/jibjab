...
import '../controller/r_will_pay_controller.dart';
import '../widget/custome_alert_dailog.dart';

class RWillPayScreen extends StatefulWidget {
  const RWillPayScreen({super.key});

  @override
  State<RWillPayScreen> createState() => _RWillPayScreenState();
}

class _RWillPayScreenState extends State<RWillPayScreen> {
  final controller = Get.find<RWillPayController>();
          ...
          child: Column(
            children: [
              ...
              AppButton(text: AppStrings.continueButton.tr, onPressed: () {
                Get.toNamed(RoutePath.rDetails);
              }),
